...
import com.netty.rpc.client.proxy.RpcMethod;
import com.netty.rpc.client.proxy.RpcMethod2;
...
public class ServiceTest2 {
    ...
    public void serviceTest1() throws Exception {
        RpcService<HelloService, RpcMethod<HelloService, String>> helloService =
    ...
    public void serviceTest2() throws Exception {
        RpcService<HelloService, RpcMethod2<HelloService, String, Integer>> helloService2 =
                RpcClient.createAsyncService(HelloService.class, "1.0");
    ...
    public void serviceTest3() throws Exception {
        RpcService<PersonService, RpcMethod2<PersonService, String, Integer>> helloService2 =
